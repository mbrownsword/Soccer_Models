  ...
  for(c in leagues){
    ...
    for(d in 1:length(p_afc$team_id)){
      ...
      if(p_afc$is_home_team[d]==TRUE){
        ...
        if(is.element(e$home_team,elo$team1)==FALSE){
          print(d)
          next()
        }
        
        if(is.element(e$away_team,elo$team2)==FALSE){
          print(d)
          next()
        }
        ...
        if(is.element(e$home_team,f_teams$team)){
          ...
          if(length(p_game$season)==0){
            p_game <- games[games$date<=(dt+21),]
          }
    ...
    p_afc <- p_afc[p_afc$opp_rating!=0,]
...
get_team_lines <- function(wc_q_stat){
...
get_game_data_by_team <- function(stat_game,pass_line_home,tkl_line_home,shots_line_home,sog_line_home,game_no, fixtures,
  ...
  for(g in 1:length(fixtures$round)){
    ...
    tackle_rate <- mean(stat_game$tkls_minus_xp, na.rm = T)
    
    team1_tackle_rate <- mean(stat_game$tkls_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    team1_tackle_rate_sd <- sd(stat_game$tkls_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    
    tackle_against_rate <- mean(stat_game$tkls_against_minus_xp, na.rm = T)
    
    team2_tackle_against_rate <- mean(stat_game$tkls_against_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    team2_tackle_against_rate_sd <- sd(stat_game$tkls_against_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    ...
    team2_tackle_rate <- mean(stat_game$tkls_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    team2_tackle_rate_sd <- sd(stat_game$tkls_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    
    team1_tackle_against_rate <- mean(stat_game$tkls_against_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    team1_tackle_against_rate_sd <- sd(stat_game$tkls_against_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    ...
    passes_rate <- mean(stat_game$pass_minus_xp, na.rm = T)
    passes_against_rate <- mean(stat_game$pass_against_minus_xp, na.rm = T)
    ...
    team1_pass_rate <- mean(stat_game$pass_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    team1_pass_rate_sd <- sd(stat_game$pass_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    
    team2_pass_against_rate <- mean(stat_game$pass_against_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    team2_pass_against_rate_sd <- sd(stat_game$pass_against_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    ...
    team2_pass_rate <- mean(stat_game$pass_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    team2_pass_rate_sd <- sd(stat_game$pass_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    
    
    team1_pass_against_rate <- mean(stat_game$pass_against_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    team1_pass_against_rate_sd <- sd(stat_game$pass_against_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    ...
    shots_rate <- mean(stat_game$shots_minus_xp, na.rm = T)
    shots_against_rate <- mean(stat_game$shots_against_minus_xp, na.rm = T)
    ...
    team1_shot_rate <- mean(stat_game$shots_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    team1_shot_rate_sd <- sd(stat_game$shots_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    
    team2_shot_against_rate <- mean(stat_game$shots_against_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    team2_shot_against_rate_sd <- sd(stat_game$shots_against_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    ...
    team2_shot_rate <- mean(stat_game$shots_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    team2_shot_rate_sd <- sd(stat_game$shots_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    
    team1_shot_against_rate <- mean(stat_game$shots_against_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    team1_shot_against_rate_sd <- sd(stat_game$shots_against_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    ...
    sogs_rate <- mean(stat_game$sogs_minus_xp, na.rm = T)
    sogs_against_rate <-  mean(stat_game$sogs_against_minus_xp, na.rm = T)
    ...
    team1_sog_rate <- mean(stat_game$sogs_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    team1_sog_rate_sd <- sd(stat_game$sogs_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    
    team2_sog_against_rate <- mean(stat_game$sogs_against_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    team2_sog_against_rate_sd <- sd(stat_game$sogs_against_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    ...
    team2_sog_rate <- mean(stat_game$sogs_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    team2_sog_rate_sd <- sd(stat_game$sogs_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    
    team1_sog_against_rate <- mean(stat_game$sogs_against_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    team1_sog_against_rate_sd <- sd(stat_game$sogs_against_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    ...
    xg_rate <- mean(stat_game$xg_minus_xp, na.rm = T)
    
    team1_xg_rate <- mean(stat_game$xg_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    team1_xg_rate_sd <- sd(stat_game$xg_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    
    xg_against_rate <- mean(stat_game$xg_against_minus_xp, na.rm = T)
    
    team2_xg_against_rate <- mean(stat_game$xg_against_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    team2_xg_against_rate_sd <- sd(stat_game$xg_against_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    ...
    team2_xg_rate <- mean(stat_game$xg_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    team2_xg_rate_sd <- sd(stat_game$xg_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    
    team1_xg_against_rate <- mean(stat_game$xg_against_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    team1_xg_against_rate_sd <- sd(stat_game$xg_against_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    ...
    xgot_rate <- mean(stat_game$xgot_minus_xp, na.rm = T)
    
    team1_xgot_rate <- mean(stat_game$xgot_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    team1_xgot_rate_sd <- sd(stat_game$xgot_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    
    xgot_against_rate <- mean(stat_game$xgot_against_minus_xp, na.rm = T)
    
    team2_xgot_against_rate <- mean(stat_game$xgot_against_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    team2_xgot_against_rate_sd <- sd(stat_game$xgot_against_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    ...
    team2_xgot_rate <- mean(stat_game$xgot_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    team2_xgot_rate_sd <- sd(stat_game$xgot_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    
    team1_xgot_against_rate <- mean(stat_game$xgot_against_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    team1_xgot_against_rate_sd <- sd(stat_game$xgot_against_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    ...
    xa_rate <- mean(stat_game$xa_minus_xp, na.rm = T)
    
    team1_xa_rate <- mean(stat_game$xa_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    team1_xa_rate_sd <- sd(stat_game$xa_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    
    xa_against_rate <- mean(stat_game$xa_against_minus_xp, na.rm = T)
    
    team2_xa_against_rate <- mean(stat_game$xa_against_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    team2_xa_against_rate_sd <- sd(stat_game$xa_against_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    ...
    team2_xa_rate <- mean(stat_game$xa_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    team2_xa_rate_sd <- sd(stat_game$xa_minus_xp[stat_game$team_name==fixtures$team2[g]], na.rm = T)
    
    team1_xa_against_rate <- mean(stat_game$xa_against_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
    team1_xa_against_rate_sd <- sd(stat_game$xa_against_minus_xp[stat_game$team_name==fixtures$team1[g]], na.rm = T)
...
get_game_player_data <- function(day_lineups,shots_ranges_all,sog_ranges_all,pass_ranges_all,tackles_ranges_all,
  ...
  for(h in 1:length(day_lineups$player)){
    ...
    if(length(stat_afc$stat_shots[stat_afc$page_url==day_lineups$pageUrl[h]&day_lineups$positionRow[h]==stat_afc$position_row])==0){
      ...
      if(length(stat_afc$stat_shots[stat_afc$page_url==day_lineups$pageUrl[h]])==0){
        
        day_lineups$minutes_shots[h] <- mean(stat_afc$stat_shots[stat_afc$position_row==day_lineups$positionRow[h]])
        day_lineups$minutes_sogs[h] <- mean(stat_afc$stat_shotsongoal[stat_afc$position_row==day_lineups$positionRow[h]])
        day_lineups$minutes_passes[h] <- mean(stat_afc$stat_passes[stat_afc$position_row==day_lineups$positionRow[h]])
        day_lineups$minutes_tackles[h] <- mean(stat_afc$stat_tackles[stat_afc$position_row==day_lineups$positionRow[h]])
        day_lineups$minutes_xg[h] <- mean(stat_afc$stat_passes[stat_afc$position_row==day_lineups$positionRow[h]])
        day_lineups$minutes_xgot[h] <- mean(stat_afc$stat_passes[stat_afc$position_row==day_lineups$positionRow[h]])
        day_lineups$minutes_xa[h] <- mean(stat_afc$stat_passes[stat_afc$position_row==day_lineups$positionRow[h]])
        
        day_lineups$sp90[h] <- mean(stat_afc$shots_90min[stat_afc$position_row==day_lineups$positionRow[h]])
        day_lineups$sogp90[h] <- mean(stat_afc$sog_90min[stat_afc$position_row==day_lineups$positionRow[h]])
        day_lineups$pp90[h] <- mean(stat_afc$pass_90min[stat_afc$position_row==day_lineups$positionRow[h]])
        day_lineups$tp90[h] <- mean(stat_afc$tkl_90min[stat_afc$position_row==day_lineups$positionRow[h]])
        day_lineups$xgp90[h] <- mean(stat_afc$xg_90min[stat_afc$position_row==day_lineups$positionRow[h]])
        day_lineups$xgotp90[h] <- mean(stat_afc$xgot_90min[stat_afc$position_row==day_lineups$positionRow[h]])
        day_lineups$xap90[h] <- mean(stat_afc$xa_90min[stat_afc$position_row==day_lineups$positionRow[h]])
...
player_prop_lines <- function(){
  ...
  games <- read_json("https://bv2.digitalsportstech.com/api/sgmGames?sb=ait&league=epl")
